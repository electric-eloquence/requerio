...
| css | `object` | {} | An object of CSS properties set by Cheerio or jQuery `.css()`. |
| data | `object` | {} | An object of data saved by Cheerio or jQuery `.data()`. Does not correspond to HTML data attributes. |
...
| prop | `object` | {} | An object of HTML properties set by Cheerio or jQuery `.prop()`. |
